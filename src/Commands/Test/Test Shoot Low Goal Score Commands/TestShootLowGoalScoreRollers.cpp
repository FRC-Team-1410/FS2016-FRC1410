...
#include "TestShootLowGoalScoreRollers.h"
...
TestShootLowGoalScoreRollers::TestShootLowGoalScoreRollers(){
...
void TestShootLowGoalScoreRollers::Initialize(){
	//This method runs only when the command is initialized
	//Nothing happens
}

void TestShootLowGoalScoreRollers::Execute(){
...
bool TestShootLowGoalScoreRollers::IsFinished(){
...
void TestShootLowGoalScoreRollers::End(){
...
void TestShootLowGoalScoreRollers::Interrupted(){
